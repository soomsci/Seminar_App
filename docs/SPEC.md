...
- 조작 버튼은 참가자 수(최대 50명)와 무관하게 스크롤 없이 항상 화면 안에 보일 것 (sticky 고정 또는 원 크기 자동 축소). [QA-3 반영]
- 강사가 새로고침하거나 노트북 절전 후 복귀해도 진행 중이던 세션으로 자동 복귀할 것 — 연수생과 동일하게 localStorage 사용. [QA-4 반영]
